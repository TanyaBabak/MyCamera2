...
class Renderer {
    ...
    private static final String FRAGMENT_SHADER_NAME = "negative.frag";
    ...
    {
        Log.e("Tanya", Thread.currentThread().getName());
    ...
    private void createProgram()
    {
        ...
        uColor = GLES30.glGetUniformLocation(mProgram, "uColor");
    }
